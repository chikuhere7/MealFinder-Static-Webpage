...
//         <p style="text-align:center;">Thank you for registering. We will contact you soon.</p>
//     `;
// }
...
document.getElementById("studentForm").addEventListener("submit", function(event) {
    ...
    if (isValid) {
        let formContainer = document.getElementById("form-container"); // The div wrapping your form
        formContainer.innerHTML = `
            <h2 style="color: green; text-align:center;">🎉 Registered Successfully!</h2>
            <p style="text-align:center;">Thank you for registering. We will contact you soon.</p>
        `;
    }
});
